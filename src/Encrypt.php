...
class Encrypt
{
     ...
     * @return string
     */
    public static function passport_encrypt($txt, $key = '5cb1bec5931b5476b3162a697fb50ddf')
    {
     ...
     * @return string
     */
    public static function passport_decrypt($txt, $key = '5cb1bec5931b5476b3162a697fb50ddf')
    {
